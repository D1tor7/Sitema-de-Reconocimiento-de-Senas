...
file = open(
    "E:\\User\\Escritorio\\Sistemas_Conversacionales\\Semana16\\LETRAS_MOVIMIENTO\\Z_meñique.txt",
    "w",
)
...
def draw_landmarks_on_image(rgb_image, detection_result):
    ...
    for idx in range(len(hand_landmarks_list)):
        ...
        x_indice.append(-x_coordinates[20])
        y_indice.append(-y_coordinates[20])
        n.append(n_i)
        n_i = n_i + 1
...
base_options = python.BaseOptions(
    model_asset_path="E:\\User\\Escritorio\\Sistemas_Conversacionales\\Semana16\\hand_landmarker.task"
)
